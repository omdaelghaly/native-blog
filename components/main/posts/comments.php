...
<div class="col-12 comments my-1" >
  ...
  <a class=""  href="/components/profiles/index.php" >
    ...
    <input type="file"  name="files[]" id="upload-file" style="display: none;" accept=".docx, .doc, .pdf" multiple>
      ...
      <input type="text" hidden  name="post_id"  style="display: none;"  value="<?php echo $postId ?>"  >
...
<div class="container" id="commentsdiv<?php echo $postId; ?>">
...
<script type="text/javascript">
       ...
       function loadcomments(post_id) {
        $.ajax({
            url: "/components/main/posts/recursionComments.php?post_id="+post_id,
            type: "GET",
            success: function(response) {
                $("#commentsdiv"+post_id).html(response);
            },
...
<span style="cursor: pointer;"  onclick="popreply(<?php echo $comment['post_id'] ?>,<?php echo $comment['id'] ?>)">

   <!-- ================================= -->
<i class="fas fa-2x fa-reply"></i><!--  <span>3</span> -->
</span>
...
<div class="col-12 commentreplies my-1 container" style="display:none"
   id="CommentrepliesDiv<?php echo $comment['id'] ?>">
...
function popreply(post_id,comment_id){
        $('#postid').val(post_id);
...
// function showHideCommentRepliesDiv(postId,commentId){
//    $('#CommentrepliesDiv'+commentId).toggle();
//    refreshReplies(commentId)
//   console.log(postId+'-'+commentId);
// }

//     function refreshReplies(comment_id) {
//         $.ajax({
//             url: '/components/main/posts/replies.php?comment_id='+comment_id,
//             type: 'GET',
//             success: function(response) {
//                 // Update the content of the div with the response from PHP
//                 $('#CommentrepliesDiv'+comment_id).html(response);
//             },
//             error: function(xhr, status, error) {
//                 console.error(xhr.responseText);
//             }
